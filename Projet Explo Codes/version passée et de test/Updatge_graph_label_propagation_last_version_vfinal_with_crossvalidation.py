...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 20 09:43:02 2020
...
def assign_point_type(test_ids,df_train_target, df_edges, edges_dict_full, passage_matrix,pct_point, nb_reinforcment, depth,prct_max_reinforced):
    ...
    result_dict=spread_known_infos(df_train_target,starts_points_id, nb_type,result_dict,edges_dict_full,depth,type_dict,passage_matrix,unmovable_type_points_id )
    result_dict,labeled_dict, not_doable_points=reinforced(edges_dict_full, depth,result_dict, type_dict,passage_matrix,prct_max_reinforced,unmovable_type_points_id,starts_points_id, nb_reinforcment=nb_reinforcment)
    result_dict=delete_known_infos(result_dict, starts_points_id)
    return result_dict,labeled_dict,not_doable_points
    
def spread_known_infos(df_train_target,starts_points_id, nb_type,result_dict,edges_dict,depth,type_dict,passage_matrix,unmovable_type_points_id ):
...
def reinforced(edges_dict, depth,result_dict, type_dict,passage_matrix,prct_max_reinforced,unmovable_type_points_id, know_points, nb_reinforcment=6):
...
def parameters_research(df_train_target, df_edges,pct_point, depth_list, nb_reinforcment_list,prct_max_reinforced_list, nb_splits,edges_dict_full ):
        ...
        for depth in depth_list:
            ...
            for nb_reinforcment in nb_reinforcment_list:
                ...
                for prct_max_reinforced in prct_max_reinforced_list:
                    raw_dict, predict_dict,not_doable_points =assign_point_type(test_ids,df_train_train_target, df_edges, edges_dict_full, passage_matrix,pct_point, nb_reinforcment, depth,prct_max_reinforced)
...
edges_dict_full=get_edges_dict(df_edges,Indexes.values, True )
...
for pct_used in [0.05,0.1,0.2,0.5,0.6]:
    ...
    best_nb_node_depth,best_nb_reinforcment,best_prct_max_reinforced=parameters_research(df_train_target, df_edges,pct_point, depth_list, nb_reinforcment_list,prct_max_reinforced_list,5,edges_dict_full )
    ...
    result_dict, labeled_dict, not_doable_points=assign_point_type(test_ids,df_train_target, df_edges, edges_dict_full, passage_matrix,pct_point, best_nb_reinforcment, best_nb_node_depth,best_prct_max_reinforced)
