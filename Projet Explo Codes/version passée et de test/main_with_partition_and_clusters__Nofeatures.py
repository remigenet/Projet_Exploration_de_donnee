...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 30 18:58:22 2020
...
def create_X(df_target,page_types, df_know_infos, df_edges, features,X_ids,partition_dict ):
    ...
    for iter in range(nb_ids):
        ...
        row_values=[id_partition]+list(direct_link.values())+list(second_link.values())+list(third_link.values())+list(fourth_link.values())
        X[iter,:]=row_values
    return X
