...
def assign_point_type(test_ids,df_train_target, df_edges, edges_dict_full, passage_matrix,pct_point, nb_reinforcment, depth,prct_max_reinforced, only_predict=False):
...
def parameters_research(df_train_target, df_edges,pct_point, depth_list, nb_reinforcment_list,prct_max_reinforced_list, nb_splits,edges_dict_full, max_workers=10 ):
    ...
    for train_fold, test_fold in kf.split(Indexes):
        ...
        for depth in depth_list:
            ...
            for result_number in range(len(results)):
                ...
                Y_real, Y_pred, nf=get_pred_vs_Y_for_found(result, df_target)
