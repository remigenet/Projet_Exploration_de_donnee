# -*- coding: utf-8 -*-
"""
Created on Sat Oct 31 18:08:21 2020
...
df_edges=pd.read_csv("C:/Users/remi/Desktop/Projet Exploration grands volume de donne/musae_facebook_edges.csv")
df_target=pd.read_csv("C:/Users/remi/Desktop/Projet Exploration grands volume de donne/musae_facebook_target.csv")
...
edge_color_dict={1: 'black', 2: 'dimgray', 3: 'gray', 4: 'darkgray',5:'silver', 6:'lightgray',7:'whitesmole',8:'azure' }
t=[]
...
for depth in range(len(my_point_list)):
    ...
    if mode=='size_by_depth':
        for point in range(len(my_point_list[depth])):
            point_size.append(len(my_point_list)/(depth+1))
...
for start_node in t:
    ...
    for node_reached in t_edges:
        if node_reached in t[:node_number]:
            ...
            edge_size_map.append(point_size[node_number]/20)
    node_number+=1
...
for iter in range(len(t)):
    print(iter)
    ax.scatter(xyz[iter,0], xyz[iter,1], xyz[iter,2], s=point_size[iter], c=color_map[iter])
    list_start=[]
    list_reached=[]
    start_node=t[iter]
    t_edges=edge_dict.get(start_node)
    ...
    if iter<10:
        plt.savefig("C:/Users/remi/Desktop/Projet Exploration grands volume de donne/image_animation/imgax0000"+str(iter)+".png")
    elif iter<100:
        plt.savefig("C:/Users/remi/Desktop/Projet Exploration grands volume de donne/image_animation/imgax000"+str(iter)+".png")
    elif iter<1000:
        plt.savefig("C:/Users/remi/Desktop/Projet Exploration grands volume de donne/image_animation/imgax00"+str(iter)+".png")
    elif iter<10000:
        plt.savefig("C:/Users/remi/Desktop/Projet Exploration grands volume de donne/image_animation/imgax0"+str(iter)+".png")
    else:
        plt.savefig("C:/Users/remi/Desktop/Projet Exploration grands volume de donne/image_animation/imgax"+str(iter)+".png")
            
image_folder = 'C:/Users/remi/Desktop/Projet Exploration grands volume de donne/image_animation/'
video_name = 'C:/Users/remi/Desktop/Projet Exploration grands volume de donne/my_animation.avi'
