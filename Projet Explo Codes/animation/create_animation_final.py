# -*- coding: utf-8 -*-
"""
Created on Sat Oct 31 14:48:48 2020
    ...
    if iter>0:
        for ii in range(0,90,1):
            ...
            if ii<10:
                ...
                plt.savefig("/tmp/rgenet/image_animation/imgax"+str(iter)+"number0"+str(ii)+".png")
            else:
                plt.savefig("/tmp/rgenet/image_animation/imgax"+str(iter)+"number"+str(ii)+".png")
    else:
        for ii in range(0,60,1):
            plt.savefig("/tmp/rgenet/image_animation/imgax"+str(iter)+"number00"+str(ii)+".png")
            
image_folder = '/tmp/rgenet/image_animation/'
video_name = 'another_animation_ff.avi'
