...
class graph_label_propagator:
    ...
    def set_parameters_manually(self,nb_reinforcment=4,depth=2,prct_max_reinforced=0.5):
    ...
    def display_classification_report(self, df_target):
        Y_real, Y_pred, nf=glp_func.get_pred_vs_Y_for_found(self.labeled_dict, df_target)
        self.print_verbose(str((1-nf/len(self.result_dict))*100)+"% of points classified")
        self.print_verbose(str((len(self.not_doable_points)/len(self.result_dict))*100)+"% of points totaly unclassifiable")
